...
- **Importar extrato**: sobe um arquivo OFX, CSV ou planilha Excel (novo .xlsx ou antigo .xls) do seu banco ou dos seus próprios controles, o Rumo identifica o formato sozinho e mostra uma prévia editável antes de importar como contas
